...
import pl.transport.truck.db.repository.CustomerWithPhoneNumberRepository
...
class CustomerWithPhoneNumberRepositoryTest extends DbSpecification {
    ...
    @Autowired
    private CustomerWithPhoneNumberRepository customerWithPhoneNumberRepository
